      ...
      <div className="sidebar-scroll">
        <nav>
          <ul className="nav">
            ...
            <li>
              <Link to="/bookings-view" className="">
                <i className="lnr lnr-home"></i> <span>Bookings</span>
              </Link>
            </li>
            <li>
              <Link to="/banners-view" className="">
                <i className="lnr lnr-home"></i> <span>Banners</span>
              </Link>
            </li>
          ...
          <li><Link to="notifications.html" className=""><i className="lnr lnr-alarm"></i> <span>Notifications</span></Link></li> */}
            <li>
              <Link to="#subPages" data-toggle="collapse" className="collapsed">
                <i className="lnr lnr-file-empty"></i> <span>Category</span>{" "}
              ...
              <div id="subPages" className="collapse ">
                <ul className="nav">
                  ...
                  <li>
                    <Link to="/category-view" className="">
                      View
                    </Link>
                  </li>
                </ul>
            ...
            <li>
              <Link
                ...
                className="collapsed"
              >
                <i className="lnr lnr-dice"></i> <span>Tickets/Packages</span>{" "}
                <i className="icon-submenu lnr lnr-chevron-left"></i>
              </Link>
              <div id="subPages1" className="collapse ">
                <ul className="nav">
                  <li>
                    <Link to="/package-add" className="">
                      Add
                    </Link>
                  </li>
                  <li>
                    <Link to="/package-view" className="">
                      View
                    </Link>
                  </li>
                </ul>

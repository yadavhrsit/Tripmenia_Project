...
function PackagePage() {
  ...
  const colorSchemes = [
    ...
    { bg: "bg-green-300", text: "text-green-800" },
    { bg: "bg-yellow-300", text: "text-yellow-800" },
    { bg: "bg-red-300", text: "text-red-800" },
    { bg: "bg-orange-300", text: "text-orange-800" },
    { bg: "bg-teal-300", text: "text-teal-800" },
    { bg: "bg-pink-300", text: "text-pink-800" },
  ];
    ...
    const fetchData = async () => {
      try {
        const response = await fetch(
          `https://tripmenia.com/api/packages/viewpackagedetail/${package_id}`
        );
        ...
        setBreadcrumbs([
          { name: "Home", link: "/" },
          {
            ...
            link: `/${data.categoryId.categoryName}`,
          },
          {
            name: data.packageName,
            link: `/${data.categoryId.categoryName}/${package_id}`,
          },
        ]);
      } catch (error) {
            ...
            <div className="w-full">
              <div className="flex justify-between border-b border-gray-lighter pb-6 md:pb-8 2xl:pb-10">
                  ...
                  >
                    {packageData.perks.map((perk, index) => {
                      ...
                      return (
                        <li
                          key={index}
                          className="p-0 mt-2 flex gap-2 items-center justify-center flex-wrap"
                        >
                          <p
                            className={`w-[32px] h-[32px] md:w-[50px] md:h-[50px] p-2 rounded-full md:text-xl ${bg} flex items-center justify-center`}
                          >
                            <i className={`${perk.icon} ${text}`} />
                          </p>
                          <p className="capitalize w-fit text-center">
                            {perk.text}
                          </p>
                        </li>
                      );
                ...
                <div className="relative">
                  ...
                  <div className="mt-2 hidden items-center gap-3 bg-zinc-200 hover:bg-black rounded-full md:flex 3xl:gap-6">
                    <button
                      type="button"
                        ...
                        <div className="relative">
                          ...
                          >
                            <div className="flex w-full items-center justify-between">
                              ...
                              <div className="flex items-center gap-4 guest-setter">
                                <button
                                  type="button"
                                  className="guest-setter inline-flex font-medium items-center justify-center focus:outline-none transition duration-200 active:scale-90 px-2.5 py-1 text-xs rounded-md bg-transparent border border-gray-300 hover:enabled:border-gray-1000 focus:enabled:border-gray-1000 focus:ring-gray-900/30 !rounded-full !p-2"
                                  onClick={() =>
                                ...
                                >
                                  <svg
                                    ...
                                    fill="currentColor"
                                    aria-hidden="true"
                                    className="h-4 w-4 xl:h-5 xl:w-5 guest-setter"
                                  >
                                    <path
                                      fillRule="evenodd"
